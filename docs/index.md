...
included to allow the players to drive the story, distributing and decentralising of the Game Master’s (GM) task 
...
Once a card is played, the challenge is introduced by the player that used the card, who is free add lore, locations and characters to the game, or even use previously mentioned characters or location and integrate then into their own scenes. 
