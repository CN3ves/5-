...
## 1) Introduction <sub><sup>[(Contents)](#table-of-contents)</sup></sub>  
...
## 2) Descriptors   <sub><sup>[(Contents)](#table-of-contents)</sup></sub>  
...
### 2.1) Descriptor Effects   <sub><sup>[(Contents)](#table-of-contents)</sup></sub>  
...
### 2.2) Descriptor Counter   <sub><sup>[(Contents)](#table-of-contents)</sup></sub>  
...
### 2.2) Descriptor Level  <sub><sup>[(Contents)](#table-of-contents)</sup></sub>  
