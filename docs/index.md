...
1. [Intruduction](#1-intro)  
2. [Descriptors](#2-desc)  
  2.1. [Effect](#21-effect)  
  2.2. [Counter](#22-counter)  
  2.3. [Level](#23-level)  

---------------------  

## 1) Introduction <sub><sup>[(Contents)](#table-of-contents)</sub></sup>  
...
## 2) Descriptors   <sub><sup>[(Contents)](#table-of-contents)</sub></sup>  
...
### 2.1) Descriptor Effects   <sub><sup>[(Contents)](#table-of-contents)</sub></sup>  
...
### 2.2) Descriptor Counter   <sub><sup>[(Contents)](#table-of-contents)</sub></sup>  
...
### 2.2) Descriptor Level  <sub><sup>[(Contents)](#table-of-contents)</sub></sup>  
